...
void ui_ScreenSettingLight_screen_init(void)
{
    ...
    lv_obj_set_x(ui_PanelScreenSettingLightList, 0);
    lv_obj_set_y(ui_PanelScreenSettingLightList, 0);
    ...
    lv_obj_set_x(ui_ButtonScreenSettingLightReturn, -30);
    lv_obj_set_y(ui_ButtonScreenSettingLightReturn, 10);
    lv_obj_set_align(ui_ButtonScreenSettingLightReturn, LV_ALIGN_TOP_RIGHT);
